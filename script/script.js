...
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
                desc: "Accéder à la liste des étudiants CDA8",
                id: 1,
            ...
            return (
                ...
                React.createElement("div", { key: restaurant.id, className: "background-image", style: styles },
    ...
    return (React.createElement(MenuSection, { icon: "fa-regular fa-pot-food", id: "restaurants-section", title: "Divers TP" }, getRestaurants()));
};
const Movies = () => {
    const getMovies = () => {
        return [{
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "github-link", className: "clear-button", href: "https://github.com/Azylos/Expernet-TP", target: "_blank" },
                    React.createElement("i", { className: "fa-brands fa-youtube" }),
                    React.createElement("span", null, "github Toma")),
